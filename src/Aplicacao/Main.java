        ...
        while (escolha != 5){
            ...
            switch (escolha){
                case 1:
                    ...
                    tamanho = selecionar(Integer.parseInt(br.readLine()), "TAMANHO");
                    pedidoTotal = tamanho;
                case 2:
                    Pedido carne;
                    System.out.println("Escolha uma carne!");
                    System.out.println("1 - Vegano \t R$3,90 \n 2 - Porco \t R$5,90 \n 3 - Boi \t R$7,90");
                    carne = selecionar(Integer.parseInt(br.readLine()), "CARNE");
                    pedidoTotal = carne;
                case 3:
                    Pedido extra;
                    ...
                    extra = selecionar(Integer.parseInt(br.readLine()), "EXTRA");
                    pedidoTotal = extra;
                case 4:
                    Pedido bebida;
                    System.out.println("Escolha uma Bebida!");
                    System.out.println("1 - Refrigerante \t R$5,90 \n 2 - O-Chá (Verde) \t R$3,90 \n 3 - KO-Chá (Preto) \t R$0,00");
                    bebida = selecionar(Integer.parseInt(br.readLine()), "BEBIDA");
                    pedidoTotal = bebida;
                case 5:
//                if (!pedido.tamanhoSelecionado){
//                    System.out.println("Você deve selecionar ao menos um tamanho!");
//                    getValoresDescricao(1);
//                }
                    System.out.println();
